...
def test_create_crud_command_without_entity_but_valid_input_should_fail(init_project):  # noqa: F811
    result = exec_command(["framefox", "create", "crud"], input_value="toto\n\n")

    assert result.returncode != 0, "Command should fail without entity"


def test_create_crud_command_with_valid_input_should_succeed(init_project):  # noqa: F811
