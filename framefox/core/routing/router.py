...
class Router:
    ...
    def register_controllers(self):
        ...
        controller_path = os.path.join(os.getcwd(), "src", "controller")
        for root, _, files in os.walk(controller_path):
            for file in files:
                ...
                try:
                    ...
                    self.logging.error(f"Failed to register controller {module_name}: {e}")
    ...
    def _register_routes(controller_instance):
        ...
        """
        for _, method in inspect.getmembers(controller_instance, predicate=inspect.ismethod):
    ...
    def _register_profiler_routes(self):
        ...
        try:
            ...
            print(f"Failed to register profiler routes: {e}")
