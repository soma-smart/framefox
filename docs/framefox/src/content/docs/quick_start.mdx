...
<CardGrid>
    <Card title="Build Your First App" icon="laptop">
        Follow the complete tutorial to build a full application.
    </Card>
    <Card title="Explore the ORM" icon="database">
        Learn to model your data with the integrated ORM.
    </Card>
    <Card title="Secure Your App" icon="shield">
