...
<Card title="💡 Pro Tip">
The Framefox terminal and workers provide an efficient way to automate recurring tasks, perform maintenance operations, and quickly scaffold components for your application.
</Card>