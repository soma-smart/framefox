...
**[📖 Complete JWT Documentation →](core/security/jwt/)**
...
**[📖 Complete OAuth Documentation →](core/security/oauth/)**
...
**[📖 Detailed JWT Setup Guide →](core/jwt/)**
...
**[📖 Detailed OAuth Setup Guide →](core/oauth/)**
...
- **[JWT Authentication Documentation →](core/jwt/)** - Complete guide to stateless API authentication with JWT tokens
- **[OAuth 2.0 Integration Documentation →](core/oauth/)** - OAuth implementation with Google, Microsoft, and custom providers
